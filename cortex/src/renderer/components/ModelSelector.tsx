...
export function ChatModelSelector(props: {}) {
  ...
  console.log("currentMergedSettings ==== "+JSON.stringify(currentMergedSettings))
  ...
  const handleMenuItemSelect = (option: string) => {
    console.log("create session is calling........... option ====== "+option)
    ...
    console.log("create session is calling...........  calling")
  ...
  console.log("currentMergedSettings.aiProvider === "+currentMergedSettings.aiProvider);
