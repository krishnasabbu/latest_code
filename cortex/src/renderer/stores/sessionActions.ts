...
export async function submitNewUserMessage(params: {
  ...
  const isChatboxAI = settings.aiProvider === ModelProvider.Custom
...
export function mergeSettings(
  ...
  if (ret.customProviders) {
    console.log("providers ============ "+JSON.stringify(ret.customProviders))
    console.log("providers ============  specital"+ JSON.stringify(specialSettings.customProviders))
    ...
    ret.customProviders = globalSettings.customProviders.map((provider) => {
      if (specialSettings.customProviders) {
        ...
        if (specialProvider) {
          console.log("providers ============  specialProvider"+ JSON.stringify(specialProvider))
          return {
            ...provider,
